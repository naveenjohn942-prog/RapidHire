...
import pandas as pd
from  copy_filename import create_sym_file,rename_file
...
if __name__ == "__main__":
    ...
    with open(DIR / fname, encoding='utf-8') as inputfile:
        df = pd.read_json(inputfile)

        df.to_csv('patterns_all.csv', encoding='utf-8', index=False)
